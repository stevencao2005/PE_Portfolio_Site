...
@app.route('/')
def index():
    about_me = "Hey! My name is Steven cao. I'm an incoming sophomore computer science student at the University of California, Irvine. I'm interested in ping pong, music, and books."
    markers  = [       
